...
class $MembersTableTable extends MembersTable with TableInfo<$MembersTableTable, MembersTableData> {
  ...
  late final GeneratedColumn<String> role =
      GeneratedColumn<String>('role', aliasedName, true, type: DriftSqlType.string, requiredDuringInsert: false);
  @override
...
class MembersTableData extends DataClass implements Insertable<MembersTableData> {
  ...
  MembersTableData copyWith({int? member, int? post, Value<String?> role = const Value.absent()}) => MembersTableData(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MembersTableData && other.member == this.member && other.post == this.post && other.role == this.role);
}
...
class MembersTableCompanion extends UpdateCompanion<MembersTableData> {
  ...
  MembersTableCompanion copyWith({Value<int>? member, Value<int>? post, Value<String?>? role, Value<int>? rowid}) {
    return MembersTableCompanion(
      member: member ?? this.member,
      post: post ?? this.post,
      role: role ?? this.role,
...
class $$MembersTableTableFilterComposer extends FilterComposer<_$PostsDatabase, $MembersTableTable> {
  ...
  ColumnFilters<String> get role => $state.composableBuilder(
      column: $state.table.role, builder: (column, joinBuilders) => ColumnFilters(column, joinBuilders: joinBuilders));
